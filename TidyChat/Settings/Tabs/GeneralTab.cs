...
namespace TidyChat.Settings.Tabs
{
    internal static class GeneralTab
    {
        public static void Draw(Configuration configuration)
        {
            ...
            ImGui.TextUnformatted(string.Format(localization.GeneralTab_BlockedMessages, configuration.TtlMessagesBlocked.ToString()));
            ...
            if (ImGui.CollapsingHeader(localization.GeneralTab_EmoteFiltersHeaderDropdown))
            {
