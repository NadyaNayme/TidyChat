...
internal static class GatheringTab
{
    public static void Draw(Configuration configuration)
    {
        ...
        SettingsTabLayout.DrawSections(true,
            (Languages.CraftingGatheringTab_GatheringLocationsDropdownHeader, () => DrawGatheringLocations(configuration)),
            (Languages.CraftingGatheringTab_AetherialReductionDropdownHeader, () => DrawAetherialReduction(configuration)),
            (Languages.CraftingGatheringTab_FishingDropdownHeader, () => DrawFishing(configuration)),
            (Languages.GatheringTab_ElementalShardsDropdownHeader, () => DrawElementalShards(configuration)),
            (Languages.CraftingGatheringTab_StellarMissionsDropdownHeader, () => DrawStellarMissions(configuration)));
    }
    ...
    private static void DrawGatheringLocations(Configuration configuration)
    {
        ...
        UiHelp.GatheringFilterMarker(Languages.CraftingGatheringTab_ShowAllOtherGatheringHelpMarker);
        ...
        SettingsTabLayout.DrawNestedOptions(configuration.ShowAllOtherGathering, () =>
        {
            ...
            UiHelp.GatheringFilterMarker(Languages.CraftingGatheringTab_ShowGatheringBuffEffectGainHelpMarker);
        });
    }
