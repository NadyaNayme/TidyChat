...
internal static class CurrenciesTab
{
    public static void Draw(Configuration configuration)
    {
        ...
        SettingsTabLayout.DrawSections(true,
            (Languages.ObtainTab_CommonCurrenciesDropdownHeader, () => DrawCommonCurrencies(configuration)),
            (Languages.ObtainTab_BattleCurrenciesDropdownHeader, () => DrawBattleCurrencies(configuration)));
    }
