    ...
    internal static class CraftingGatheringTab
    {
        public static void Draw(Configuration configuration)
        {
            if (ImGui.CollapsingHeader(localization.CraftingGatheringTab_DesynthesisDropdownHeader))
            {
                ...
                if (ImGui.Checkbox(localization.CraftingGatheringTab_ShowDesynthesisLevelIncreasesMessages, ref showDesynthesisLevel))
                {
                ...
                if (ImGui.Checkbox(localization.CraftingGatheringTab_ShowObtainedItemsFromDesynthesisMessages, ref showDesynthesisObtains))
                {
            ...
            if (ImGui.CollapsingHeader(localization.CraftingGatheringTab_MateriaDropdownHeader))
            {
                ...
                if (ImGui.Checkbox(localization.CraftingGatheringTab_ShowMateriaSuccesfullyAttachedMessages, ref showAttachedMateria))
                {
                ...
                if (ImGui.Checkbox(localization.CraftingGatheringTab_ShowMateriaOvermeldFailuresMessages, ref showOvermeldFailure))
                {
                ...
                if (ImGui.Checkbox(localization.CraftingGatheringTab_ShowSuccesfullyRetrievedMateriaMessages, ref showMateriaRetrieved))
                {
            ...
            if (ImGui.CollapsingHeader(localization.CraftingGatheringTab_CraftingDropdownHeader))
            {
                ...
                if (ImGui.Checkbox(localization.CraftingGatheringTab_ShowOtherPlayerCompletedSynthesisMessages, ref showOtherSynthesis))
                {
            ...
            if (ImGui.CollapsingHeader(localization.CraftingGatheringTab_GatheringLocationsDropdownHeader))
            {
                ...
                if (ImGui.Checkbox(localization.CraftingGatheringTab_ShowObtainedSandsFromAetherialReductionMessages, ref showAetherialReductionSands))
                {
                ...
                if (ImGui.Checkbox(localization.CraftingGatheringTab_ShowLocationGatheringEffectMessages, ref showLocationAffects))
                {
                ...
                if (ImGui.Checkbox(localization.CraftingGatheringTab_HideGatheringYieldLocationMessages, ref hideGatheringYield))
                {
                ...
                if (ImGui.Checkbox(localization.CraftingGatheringTab_HideGatheringAttemptsLocationMessages, ref hideGatheringAttempts))
                {
                ...
                if (ImGui.Checkbox(localization.CraftingGatheringTab_HideGatheringBoonLocationMessages, ref hideGatherersBoon))
                {
