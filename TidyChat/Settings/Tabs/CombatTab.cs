...
internal static class CombatTab
{
    ...
    {
        SettingsTabLayout.DrawTabNote(Languages.CombatTab_FilteringNote);

        SettingsTabLayout.DrawSections(true,
            (Languages.CombatTab_CastingAndAbilitiesDropdownHeader, () => DrawCastingAndAbilities(configuration)),
            (Languages.CombatTab_DamageHealingAndEffectsDropdownHeader, () => DrawDamageHealingAndEffects(configuration)),
            (Languages.CombatTab_DefeatAndAddsDropdownHeader, () => DrawDefeatAndAdds(configuration)));
    }

    private static void DrawCastingAndAbilities(Configuration configuration)
    {
