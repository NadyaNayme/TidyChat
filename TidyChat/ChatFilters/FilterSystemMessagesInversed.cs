        ...
        public static bool IsFiltered(string input, Configuration configuration)
        {
            try
            {
                if (
                    ...
                    !configuration.HideSSRankHunt && L10N.Get(ChatStrings.ExtraordinarilyPowerfulMark).All(input.Contains) ||
                    !configuration.HideCompletedVenture && L10N.Get(ChatStrings.CompletedVenture).All(input.Contains) ||
                    !configuration.HideCommendations && !configuration.BetterCommendationMessage && L10N.Get(ChatStrings.PlayerCommendation).All(input.Contains) ||
                    ...
                    !configuration.HideSpideySenses && L10N.Get(ChatStrings.SpideySenses).All(input.Contains) && !L10N.Get(ChatStrings.UnsettlingPresence).All(input.Contains) ||
                    !configuration.HideAetherCompass && L10N.Get(ChatStrings.AetherCompass).All(input.Contains) ||
                    !configuration.HideCountdownTime && (L10N.Get(ChatStrings.CountdownTime).All(input.Contains) || L10N.Get(ChatStrings.CountdownEngage).All(input.Contains)) ||
                    ...
                    configuration.BetterCommendationMessage && L10N.Get(ChatRegexStrings.BetterPlayerCommendation).IsMatch(input) ||
                    ...
                    configuration.ShowAwaitingTradeConfirmation && L10N.Get(ChatStrings.AwaitingTradeConfirmation).All(input.Contains) ||
                    ...
                    configuration.ShowAetherialReductionSands && L10N.Get(ChatRegexStrings.AetherialReductionSands).IsMatch(input) ||
                    configuration.ShowSealedOff && L10N.Get(ChatRegexStrings.SealedOff).IsMatch(input) ||
                    !configuration.HideSearchForItemResults && L10N.Get(ChatRegexStrings.SearchForItemResults).IsMatch(input) ||
                    !configuration.HideQuestReminder && configuration.BetterSayReminder && L10N.Get(ChatStrings.SayQuestReminder).All(input.Contains) ||
                    ...
                    configuration.ShowRestoresLifeToFallen && L10N.Get(ChatRegexStrings.RestoresLifeToFallen).IsMatch(input) ||
                    ...
                    configuration.ShowAetherpoolIncrease && L10N.Get(ChatRegexStrings.AetherpoolIncrease).IsMatch(input) ||
                    configuration.ShowAetherpoolUnchanged && L10N.Get(ChatRegexStrings.AetherpoolUnchanged).IsMatch(input) ||
                    ...
                    configuration.ShowPomanderOfAffluence && L10N.Get(ChatRegexStrings.PomanderOfAffluence).IsMatch(input) ||
                    configuration.ShowPomanderOfFlight && L10N.Get(ChatRegexStrings.PomanderOfFlight).IsMatch(input) ||
                    configuration.ShowPomanderOfAlteration && L10N.Get(ChatRegexStrings.PomanderOfAlteration).IsMatch(input) ||
                    configuration.ShowPomanderOfWitching && L10N.Get(ChatRegexStrings.PomanderOfWitching).IsMatch(input) ||
                    configuration.ShowPomanderOfSerenity && L10N.Get(ChatRegexStrings.PomanderOfSerenity).IsMatch(input) ||
                    configuration.ShowFloorNumber && L10N.Get(ChatRegexStrings.FloorNumber).IsMatch(input) ||
                    configuration.ShowSenseAccursedHoard && L10N.Get(ChatRegexStrings.SenseAccursedHoard).IsMatch(input) ||
                    configuration.ShowDoNotSenseAccursedHoard && L10N.Get(ChatRegexStrings.DoNotSenseAccursedHoard).IsMatch(input) ||
                    configuration.ShowDiscoverAccursedHoard && L10N.Get(ChatRegexStrings.DiscoverAccursedHoard).IsMatch(input) ||
