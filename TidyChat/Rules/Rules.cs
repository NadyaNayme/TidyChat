...
public static partial class Rules
{
    ...
    private static readonly Dictionary<string, Func<Configuration, bool>> ConfigAccessors = new(StringComparer.Ordinal)
    {
        ...
        ["ShowQuestEquipmentRequirement"] = _ => true,
        ...
        ["ShowConfigChangeMessages"] = c => c.ShowConfigChangeMessages,
        ...
        ["ShowInvalidCommandError"] = c => c.ShowInvalidCommandError,
        ["ShowFriendListMessages"] = c => c.ShowFriendListMessages,
